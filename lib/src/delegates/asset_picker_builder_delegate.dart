...
import 'package:wechat_assets_picker/src/widget/text_style.dart';
...
abstract class AssetPickerBuilderDelegate<Asset, Path> {
  ...
  /// 资源列表项的构建
  Widget assetGridItemBuilder(BuildContext context,
      int index,
      List<Asset> currentAssets,);

  /// The [Semantics] builder for the assets' grid.
  /// 资源列表项的语义构建
  Widget assetGridItemSemanticsBuilder(BuildContext context,
      int index,
      Asset asset,
      Widget child,);
  ...
  /// 音频资源的部件构建
  Widget audioItemBuilder(BuildContext context,
      int index,
      Asset asset,);

  /// The item builder for images and video type of asset.
  /// 图片和视频资源的部件构建
  Widget imageAndVideoItemBuilder(BuildContext context,
      int index,
      Asset asset,);
...
class DefaultAssetPickerBuilderDelegate
  ...
  @override
  Future<void> selectAsset(BuildContext context,
      AssetEntity asset,
      bool selected,) async {
  ...
  Future<void> _pushAssetToViewer(BuildContext context,
      int index,
                ...
                RepaintBoundary(
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 10),
                        child: Text('Pilih Maksimal 10 Foto',style: customFont(fontSize: 16,fontWeight: FontWeight.w600),),
                      ),
      ...
      builder: (_, DefaultAssetPickerProvider p, __) {
        return MaterialButton(
          ...
          child: ScaleText(
            ...
            style: customFont(
              color:
              p.isSelectedNotEmpty ? Colors.white : const Color(0xFFD4D4D4),
              fontSize: 16,
            ...
            ValueListenableBuilder<PermissionState>(
              ...
              builder: (_, PermissionState ps, Widget? child) =>
                  Semantics(
                    ...
                    excludeSemantics: true,
                    child: isPermissionLimited ? child : const SizedBox
                        .shrink(),
                  ),
              child: Padding(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                            ...
                            children: <Widget>[
                              Flexible(
                                child: Padding(
                                  ...
                                  child: ScaleText(
                                    name,
                                    style: customFont(fontWeight: FontWeight.w500,fontSize: 18),
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                  ),
                                ),
                    ...
                    const AspectRatio(
                        aspectRatio: 1,
                        child: Icon(Icons.keyboard_arrow_right, color: Colors.black, size: 26),
                      ),
                  ],
                ),
              ),
                    ...
                    Padding(
                      ...
                      child: ScaleText(
                        '${textDelegate.preview}'
                            '${p.isSelectedNotEmpty ? ' (${p.selectedAssets
                            .length})' : ''}',
                        style: TextStyle(
            ...
            return Stack(
              children: [
                ...
                AnimatedContainer(
                  duration: switchingPathDuration,
                  color: selected
                      ? const Color(0x593F8C7A)
                      : Colors.transparent,
                  child: Container(),
                ),
                if (selected && !isSingleAssetMode) Padding(
